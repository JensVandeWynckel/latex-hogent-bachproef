...
\newglossaryentry{ssl}{
    name={SSL},
    description={Secure Sockets Layer, een protocol voor het beveiligen van communicatie over het internet}
}

\newglossaryentry{https}{
    name={HTTPS},
    description={Hypertext Transfer Protocol Secure, een beveiligde versie van HTTP die SSL/TLS gebruikt voor encryptie}
}
