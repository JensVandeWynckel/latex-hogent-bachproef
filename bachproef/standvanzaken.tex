...
% Met het oog op de \gls{avg} zijn strikte regels met betrekking tot toestemming en transparantie bij de verwerking van \gls{pii}. 
...
% \textbf{Tabel moet nog naar Nederlands verzet worden!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!}
...
Een voorbeeld van een vooraf gedefinieerde regelset is de regelset voor \texttt{DLP-PII}, die is ontworpen om gevoelige persoonlijke informatie te identificeren en te beschermen. 
...
% Bovendien is een toenemende vraag naar het ontwikkelen van API\--integraties voor Security Information and Event Management (\gls{siem})\--systemen, 
...
Bij het evalueren van DLP-oplossingen binnen een \gls{sase}-architectuur wordt Netskope gekozen vanwege de unieke combinatie van functionaliteiten en prestaties die het biedt, 
...
%     \centering
%     \scriptsize
%     \includegraphics[width=0.6\textwidth]{img/netskopeinnovator.png}
...
%     \centering
%     \scriptsize
%     \includegraphics[width=0.6\textwidth]{img/netskope2024.png}
...
% zijn  diverse manieren om hun impact te beperken. 
...
% Om deze data te beschermen worden Data Loss Prevention (DLP)-systemen ingezet die gebruikmaken van AI en machine learning om potentieel 
...
% is opvallend weinig onderzoek dat zich richt op de operationele impact van deze valse meldingen. 
